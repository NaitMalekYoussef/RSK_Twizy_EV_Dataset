...
(RSK), Morocco.
During the collect of the dataset (the collect process take place in diffrent days, between March to Jully 2021), three main trajectories were selected; T1,T2 and T3.
